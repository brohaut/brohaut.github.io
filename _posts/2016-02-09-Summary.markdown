...
As an active member of the collaborative project (“GENER”, Groupe d’Exploration Neurologique en Réanimation) led by **Prof Tarek Sharshar** since 2009, I am also highly invested in the research about brain dysfunction in ICU patients, its relation with delirium, mortality and long-term outcome ([7](https://doi.org/10.1371/journal.pone.0176012), [8](http://dx.doi.org/10.1097/CCM.0b013e31821b843b)).

My PhD research, done at the Brain & Spine Institute (ICM) – Paris, under the supervision of Prof Lionel Naccache, explored the relations between semantic processing and consciousness both in brain injured patients and healthy volunteers. Failing to replicate a set of classical 30 years old results, we could finally reframe a well- established model of semantic unconscious processing ([9](https://doi.org/10.1093/nc/niw010)). Taking advantage of this experience in fundamental cognitive neuroscience, I continue to develop cutting edges approaches to improve the monitoring, the assessment of brain functions and the neuro-prognosis of ICU patients.
