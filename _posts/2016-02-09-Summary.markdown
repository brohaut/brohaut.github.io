...
During my PhD at the Sorbonne University / Brain & Spine Institute (ICM) – Paris under the supervision of Prof Lionel Naccache, I have explored the [Relations between Language & Consciousness](https://tel.archives-ouvertes.fr/tel-01372200) both in brain injured patients and healthy volunteers ([3](http://dx.doi.org/10.1016/j.neuropsychologia.2011.12.015)). Trying to replicate a set of classical 30 year old results, we could finally reframe a well- established model of semantic unconscious processing ([10](https://doi.org/10.1093/nc/niw010), [post]({{ site.url }}/2017/Article-polysemy/)).
